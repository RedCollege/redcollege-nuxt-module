...
import type { ApiModules, InformesModules, PlanificacionesModules, HealthModules, EstablecimientoModules, MatriculasModules, CurriculumModules, GeneralModules, AuthModules } from '../utils/apiModuleFactory';
