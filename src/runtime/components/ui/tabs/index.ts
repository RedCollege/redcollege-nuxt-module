    ...
    "inline-flex items-center justify-center whitespace-nowrap text-sm  transition-all disabled:pointer-events-none px-3",
    {
        variants: {
            variant: {
                ...
                ring: 
                    "text-muted-foreground flex items-center gap-2 ring-0 px-4 h-8 outline-none font-medium shadow-none data-[state=active]:shadow-none data-[state=active]:ring-2 data-[state=active]:ring-primary  disabled:opacity-100 data-[state=active]:text-primary rounded-full  "
            },  
            size: {
                default: "",
                sm: " text-xs",
